...
$sql = "SELECT * FROM user WHERE verifyStatus = 'Verified' AND userType != 'Admin' ";
$id = $conn->query($sql);

$countAmount = mysqli_query($conn, "SELECT SUM(uBalance) AS totalAmount FROM user WHERE verifyStatus = 'Verified' AND userType != 'Admin' ");
